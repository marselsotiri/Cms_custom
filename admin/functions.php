...
//        }else{
//            
//       $query="INSERT INTO categories(cat_title) ";   $query .= "VALUE('{$cat_title}')";
//            
...
//Ky funksion merret me rregullimin e tabeles ne dashbord, posts , categories,comments,users
function recordCount($table){
   global $connection;  
   $query="SELECT * FROM " . $table;        $select_all_post = mysqli_query($connection, $query); 
