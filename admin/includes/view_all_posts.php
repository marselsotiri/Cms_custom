...
include("delete_modal.php");
 ...
 break;
    ...
    while($row=mysqli_fetch_array($select_post_query)){
        ...
        $post_image=$row['post_image']; $post_tags=$row['post_tags']; 
...
$user_id=$row['user_id'];
$post_author=$row['post_author'];
$post_user = $row['post_user'];                   $post_title = $row['post_title'];
$post_category_id = $row['post_category_id'];
$post_status = $row['post_status'];
...
echo "<td><a class='btn btn-primar' href='../post.php?p_id={$post_id}'>View Post</a></td>"; 
...
<?php     
//echo "<td><a rel='$post_id' href='javascript:(0)' class='delete_link'>Delete</a></td>";
