...
$elemnts_text=['All Posts','Active Posts','Draft Posts', 'Comment', 'Pending Comments', 'Users', "Subscribers", 'Categories'];        
$elemnt_count=[$post_count, $post_published_count, $post_draft_count, $comment_count, $unapproved_comments_count, $user_count, $subscriber_count, $category_count];             
