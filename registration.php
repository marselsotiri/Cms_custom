...
if(email_exists($email)){
  ...
  $error['username']='Email already exists, <a href="index.php">Plase login</a>';   
...
?>
    ...
    <form method="get" class="navbar-from navbar-right" action="" id="language_form">
        
   <div class="form-group">
   <select name="lang" class="form-control" onchange="changeLanguage()">
       <option value="en" <?php if(isset($_SESSION['lang']) && $_SESSION['lang'] == 'en'){echo "selected"; }
    ?>>English</option>
       <option value="shq" <?php if(isset($_SESSION['lang']) && $_SESSION['lang'] == 'shq'){echo "selected"; }
    ?>>Albanian</option>
   </select>    
   </div>     
